<?php
/**
 * php-html-meta-parser
 *
 * Extract html meta data from a html document, priority given to meta with open graph properties,
 * then twitter, then conventional meta tags
 * 
 * @see     <https://github.com/onassar/PHP-Curler>
 * @author  Tommy Ku <zoo1929@outlook.com>
 * @todo    add support for getting author
 */
